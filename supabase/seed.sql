...
(
  ...
  array['unauthorized access','cyber incident','cybersecurity incident','ransomware','data breach','data exfiltration','customer data','incident response','remediation','information security'],
...
(
  ...
  array['board','audit committee','risk committee','cyber risk','regulatory inquiry','legal proceedings','material weakness','security controls','internal control','governance'],
...
(
  ...
  array['identity compromise','credential','access control','account takeover','privileged access','multi-factor','authentication','unauthorized user','permissions'],
